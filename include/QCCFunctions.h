...
CGRect QCComputeAspectRatioBounds(CGRect bounds, double ratio); // returns an adjusted rect based on ratio that will fit within bounds.  ratios <0 just return bounds.
